...
export default function Navbar() {
  ...
  return (
    <>
      ...
      >
        <div ref={glowRef} className="pointer-events-none absolute w-[300px] h-[300px] bg-white/5 rounded-full blur-3xl -translate-x-1/2 -translate-y-1/2 mix-blend-screen opacity-0 md:opacity-100" />

        <div className="max-w-7xl mx-auto px-6 flex justify-between items-center relative z-10">

          {/* Logo */}
          <div className="flex items-center gap-2 cursor-pointer group">
            <span className="text-white font-bold tracking-widest uppercase text-sm opacity-90 group-hover:opacity-100 transition-opacity">
              Om<span className="text-red-500">.</span>dev
            </span>
          </div>
          ...
          <div className="hidden md:block">
            <a
              href="mailto:ommahato2005@gmail.com"
          ...
          {/* Mobile Hamburger */}
          <button className="md:hidden text-white p-2 z-50 relative" onClick={() => setIsMobileMenuOpen(!isMobileMenuOpen)}>
      ...
      {/* Mobile Menu */}
      <div ref={mobileMenuRef} className="fixed inset-0 bg-black/95 backdrop-blur-xl z-40 flex flex-col justify-center items-center" style={{ clipPath: 'circle(0% at 90% 10%)' }}>
        <div className="flex flex-col space-y-8 text-center mt-10">
          {NAV_LINKS.map((link, index) => (
            <a
              ...
              className="text-3xl font-light text-gray-400 hover:text-white transition-colors tracking-widest"
            >
              {link.name}
            </a>
          ))}
          <a
            href="mailto:ommahto264@gmail.com"
